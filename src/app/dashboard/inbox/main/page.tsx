...
import { MailCheck, Database, Search, Tag, Square, RefreshCw, ChevronLeft, ChevronRight, Star, Eye, ShieldAlert } from 'lucide-react';
...
export default function MainInboxPage() {
  ...
  return (
    <>
      <main className="flex flex-1 flex-col h-full bg-background relative">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-6">
                            <motion.div
                                ...
                                className="relative flex items-center justify-center animation-wrapper-1 w-16 h-16 text-primary"
                            >
