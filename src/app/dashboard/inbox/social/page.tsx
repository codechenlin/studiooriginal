...
import { Database, Search, Tag, Square, RefreshCw, ChevronLeft, ChevronRight, Star, Eye, ShieldAlert, Users, XCircle } from 'lucide-react';
        ...
        <Card className="bg-card/80 backdrop-blur-sm border-[#00ADEC]/30 shadow-lg mb-2 relative overflow-hidden">
          ...
          <CardContent className="p-4 flex flex-col md:flex-row items-center justify-between gap-4 relative z-10">
            ...
            <div className="relative w-full md:flex-1">
             ...
             <div className="flex items-center gap-2">
                <Button variant="outline" className="w-full md:w-auto bg-background/70 border-[#00ADEC]/30 hover:bg-cyan-500 hover:text-white" onClick={() => setIsTagFilterModalOpen(true)}>
