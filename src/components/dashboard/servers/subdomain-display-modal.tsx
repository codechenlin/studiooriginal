        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent showCloseButton={false} className="max-w-4xl w-full h-[650px] flex flex-col p-0 gap-0 bg-black/80 backdrop-blur-xl border text-white overflow-hidden" style={{borderColor: recommendationColor+'4D'}}>
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 overflow-hidden">
                    ...
                    <div className="p-8 flex flex-col items-center justify-center bg-black/30 border-r border-cyan-400/20 text-center relative overflow-hidden animated-grid">
                    ...
                    <div className="p-8 flex flex-col items-center justify-center bg-black/20 space-y-8">
                        ...
                        >
                            ...
                            <div className="mt-2 px-4 py-2 rounded-md font-mono text-4xl font-bold character-cell">
