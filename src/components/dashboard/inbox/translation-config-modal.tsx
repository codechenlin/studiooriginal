                ...
                <div className="py-6 z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col text-center">
                        ...
                        <div className="flex-grow flex flex-col justify-between">
                            ...
                            <div className="mt-4 relative p-4 rounded-lg bg-black/30 border border-purple-400/20 flex flex-col items-center justify-center min-h-[250px]">
                                <motion.div
                     ...
                     <div className="flex flex-col text-center">
                        ...
                        <div className="flex-grow flex flex-col justify-between">
                            <div className="min-h-[52px] flex items-center justify-center gap-2">
                                <div className="relative flex-1">
                                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-purple-300/70" />
                                    <Input
                                        type="text"
